...
<script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.success){
                            ...
                            html+='<a class="myHref" href="javascript:void(0);" onclick="showeditmodal(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #ff0000;"></span></a>';
                            html+='&nbsp;&nbsp;&nbsp;&nbsp;';
	...
	function showremark() {
		$.ajax({
			url:"workbench/activity/showActMarklist.do",
			data:{
				"id":"${activity.id}"
			},
			dataType:"json",
    ...
    function showeditmodal(id) {
        ...
        $("#remarkId").val(id)
        $.ajax({
            url:"workbench/activity/showeditmodal.do",
            data:{
                "id":id,
            },
            dataType:"json",
